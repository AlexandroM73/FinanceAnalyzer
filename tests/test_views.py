...
class TestViews(unittest.TestCase):
    ...
    def test_home_page_dashboard_error(self, mock_get_dashboard_data):
        ...
        mock_get_dashboard_data.return_value = {"error": "API Error", "status": "error"}
    ...
    def test_events_page_empty_dataframe(self, mock_get_events_data, mock_read_excel):
        ...
        @parameterized.expand(
            [("2023-01-01 00:00:00", 2023), ("2024-12-31 23:59:59", 2024), ("2025-06-15 12:30:45", 2025)]
        )
        @patch("src.utils.get_dashboard_data")
        ...
        def test_events_page_large_dataset(self, mock_get_events_data, mock_read_excel):
            ...
            large_data = [
                {"Дата операции": datetime.now() - timedelta(days=i), "Сумма": i * 10, "Описание": f"Транзакция {i}"}
        ...
        def test_events_page_date_conversion(self, mock_get_events_data, mock_read_excel):
            ...
            test_dates = ["2023-10-01", "2023-10-15", "2023-11-01"]

            test_df = pd.DataFrame({"Дата операции": test_dates, "Сумма": [100, 200, 150]})
